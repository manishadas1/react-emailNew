...
function App() {
  ...
  const filteredEmails = inboxSelected
    ...
    : starredEmails
    ? emailData.email.filter((email, index) => starredEmails[index])
    : [];
          ...
          <div className="first-sec">
            ...
            >
             ...
             <span className="h"> Inbox </span>
              <span className="unread-count" style={{ marginLeft: "100px" }}>
                {unreadCount}
              </span>
            </div>
            ...
            <div
              ...
              onClick={() => {
                ...
                setCheckedEmails(Array(emailData.email.length).fill(false));
                setCurrentPage(1);
              }}
            >
                ...
                <div className="email-flex">
                  ...
                  >
                    <div className="email-sender">
                      <span>
                        {readEmails[index] ? (
                          <span style={{ color: "gray" }}>{email.Name}</span>
                        ) : (
                          email.Name
                        )}
                      </span>
                    ...
                    <div className="email-subject">
                      <span>
                        {readEmails[index] ? (
                          <span style={{ color: "gray" }}>{email.mail}</span>
                        ) : (
                          email.mail
                        )}
                      </span>
